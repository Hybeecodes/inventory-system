...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.api.getData('/equipmentCount').then(function (equipment) {
            console.log(equipment);
            _this.equipments = equipment['message'];
        });
        this.api.getData('/equipmentTypeCount').then(function (equipmenttypes) {
            console.log(equipmenttypes);
            _this.equipmentTypes = equipmenttypes['message'];
        });
        this.api.getData('/officeCount').then(function (offices) {
            console.log(offices);
            _this.offices = offices['message'];
        });
    };
